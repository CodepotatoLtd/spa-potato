...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center bg-white min-h-screen sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img src="https://codepotato.co.uk/assets/codepotato-logo.jpg" alt="Codepotato Logo" class="h-16 w-auto">
                </div>
